<%--
addtophotofriend.jsp: redirect-get page adding photos for PhotoShare web app. 
	...
	<body>
		...
		<% 
			...
			try {
				...
				Comment c = new Comment(user_id, picture_id, request.getParameter("comment")); 
				commentDao.save(c); 
				
				if (request.getParameter("like") != null) { 
					PictureDao pictureDao = new PictureDao(); 
					pictureDao.addLike(picture_id); 
				} 
			...
			if (err != null) {
				...
				out.println("<p>You've successfully updated their photos.</p>"); 
				out.println("</div>"); 
				out.println("</section>"); 
			}
